...
dataset_path = current_directory + '/../dataset/hindmarsh_rose_dataset.npy'
...
csode_adapt_g = csode_utils.AdaptODEFuncG_1D(input_dim, 64)
...
cstode_g = csode_utils.AdaptODEFuncG_1D(input_dim, 64)
